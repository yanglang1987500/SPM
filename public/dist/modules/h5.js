	...
	module.exports = {
	    load:function(callback){
	        ...
	        $.get('/auth/menu/list',function(data){
	            ...
	            arr.push({path:'/',component:__webpack_require__(11)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_options__.functional) {console.error("[vue-loader] vue-navigator.vue: functional components are not supported and should be defined in plain js files using render functions.")}
