	    ...
	    load:function(callback){
	        ...
	        $.get('/auth/menu/list',function(data){
	            ...
	            for(var i = 0,len = menuList.length;i<len;i++){
	                ...
	                if(flag){
	                    var mod = __webpack_require__(96)("./"+RegExp.$1+'.vue');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(37)(IteratorPrototype, __webpack_require__(61)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueNavigator = __webpack_require__(88);
