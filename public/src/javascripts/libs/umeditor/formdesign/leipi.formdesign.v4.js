...
* 设计器私有的配置说明 
* 一
* UM.leipiFormDesignUrl  插件路径
* 
* 二
*UM.getEditor('myFormDesign',{
*          toolleipi:true,//是否显示，设计器的清单 tool
*/
UM.leipiFormDesignUrl = 'formdesign';
/**
 * 文本框
 * @command textfield
 * @method execCommand
 ...
 * ```
 */
UM.plugins['text'] = function () {
	var me = this,thePlugins = 'text';
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UM.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/text.html',
				name:thePlugins,
				editor:this,
				title: '文本框',
 ...
 * ```
 */
UM.plugins['macros'] = function () {
    var me = this,thePlugins = 'macros';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/macros.html',
                name:thePlugins,
                editor:this,
                title: '宏控件',
...
UM.plugins['radio'] = function () {
    var me = this,thePlugins = 'radio';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/radio.html',
                name:thePlugins,
                editor:this,
                title: '单选框',
 ...
 */
 /*
UM.plugins['checkbox'] = function () {
    var me = this,thePlugins = 'checkbox';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/checkbox.html',
                name:thePlugins,
                editor:this,
                title: '复选框',
 ...
 * ```
 */
UM.plugins['radios'] = function () {
    var me = this,thePlugins = 'radios';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/radios.html',
                name:thePlugins,
                editor:this,
                title: '单选框组',
                cssRules:"width:590px;height:370px;",
 ...
 * ```
 */
UM.plugins['checkboxs'] = function () {
    var me = this,thePlugins = 'checkboxs';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/checkboxs.html',
                name:thePlugins,
                editor:this,
                title: '复选框组',
 ...
 * ```
 */
UM.plugins['textarea'] = function () {
    var me = this,thePlugins = 'textarea';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/textarea.html',
                name:thePlugins,
                editor:this,
                title: '多行文本框',
 ...
 * ```
 */
UM.plugins['select'] = function () {
    var me = this,thePlugins = 'select';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/select.html',
                name:thePlugins,
                editor:this,
                title: '下拉菜单',
                cssRules:"width:590px;height:370px;",
 ...
 * ```
 */
UM.plugins['progressbar'] = function () {
    var me = this,thePlugins = 'progressbar';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/progressbar.html',
                name:thePlugins,
                editor:this,
                title: '进度条',
 ...
 * ```
 */
UM.plugins['qrcode'] = function () {
    var me = this,thePlugins = 'qrcode';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/qrcode.html',
                name:thePlugins,
                editor:this,
                title: '二维码',
 ...
 * ```
 */
UM.plugins['listctrl'] = function () {
    var me = this,thePlugins = 'listctrl';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/listctrl.html',
                name:thePlugins,
                editor:this,
                title: '列表控件',
...
UM.plugins['more'] = function () {
    var me = this,thePlugins = 'more';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/more.html',
                name:thePlugins,
                editor:this,
...
UM.plugins['error'] = function () {
    var me = this,thePlugins = 'error';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/error.html',
                name:thePlugins,
                editor:this,
                title: '异常提示',
...
UM.plugins['leipi'] = function () {
    var me = this,thePlugins = 'leipi';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/leipi.html',
                name:thePlugins,
                editor:this,
                title: '表单设计器 - 清单',
...
UM.plugins['leipi_template'] = function () {
    var me = this,thePlugins = 'leipi_template';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UM.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UM.leipiFormDesignUrl+'/template.html',
                name:thePlugins,
                editor:this,
                title: '表单模板',
...
UM.registerUI('button_leipi',function(editor,uiName){
...
UM.registerUI('button_template',function(editor,uiName){
    if(!this.options.toolleipi)
    {
        return false;
    }
...
UM.registerUI('button_preview',function(editor,uiName){
    if(!this.options.toolleipi)
    {
        return false;
    }
...
UM.registerUI('button_save',function(editor,uiName){
    if(!this.options.toolleipi)
    {
        return false;
    }
